...
/* harmony export (immutable) */ __webpack_exports__["promisifyRouteParams"] = promisifyRouteParams;
...
function promisifyRouteParams(fn) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_loader_config__ = __webpack_require__(27);
...
/* harmony default export */ __webpack_exports__["a"] = function (_ref) {
  ...
  var config = {
    ...
    output: {
      publicPath: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["urlJoin"])(this.options.router.base, '/_nuxt/')
    },
    performance: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_chokidar__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_chokidar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_chokidar__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_hash_sum__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_hash_sum___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_hash_sum__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_pify__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_pify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_pify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_webpack__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_serialize_javascript__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_vue_server_renderer__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__webpack_client_config_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__webpack_server_config_js__ = __webpack_require__(26);
...
var _marked = [build, buildFiles, generateRoutesAndFiles].map(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.mark);
...
var remove = __WEBPACK_IMPORTED_MODULE_9_pify___default()(__WEBPACK_IMPORTED_MODULE_7_fs_extra___default.a.remove);
var readFile = __WEBPACK_IMPORTED_MODULE_9_pify___default()(__WEBPACK_IMPORTED_MODULE_7_fs_extra___default.a.readFile);
var writeFile = __WEBPACK_IMPORTED_MODULE_9_pify___default()(__WEBPACK_IMPORTED_MODULE_7_fs_extra___default.a.writeFile);
var mkdirp = __WEBPACK_IMPORTED_MODULE_9_pify___default()(__WEBPACK_IMPORTED_MODULE_7_fs_extra___default.a.mkdirp);
var glob = __WEBPACK_IMPORTED_MODULE_9_pify___default()(__webpack_require__(33));
var reqSep = /\//g;
var sysSep = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.escapeRegExp(__WEBPACK_IMPORTED_MODULE_13_path__["sep"]);
...
var r = function r() {
  ...
  if (__WEBPACK_IMPORTED_MODULE_4_lodash___default.a.last(args).indexOf('~') !== -1) {
    return wp(__WEBPACK_IMPORTED_MODULE_4_lodash___default.a.last(args));
  }
  args = args.map(normalize);
  return wp(__WEBPACK_IMPORTED_MODULE_13_path__["resolve"].apply(null, args));
};
// force green color
debug.color = 2;
...
function options() {
  ...
  if (!this.dev) {
    ...
    var bundlePath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["join"])(serverConfig.output.path, serverConfig.output.filename);
    if (__WEBPACK_IMPORTED_MODULE_7_fs_extra___default.a.existsSync(bundlePath)) {
      var bundle = __WEBPACK_IMPORTED_MODULE_7_fs_extra___default.a.readFileSync(bundlePath, 'utf8');
...
function build() {
  return __WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.wrap(function build$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          // Check if pages dir exists and warn if not
          if (!__WEBPACK_IMPORTED_MODULE_7_fs_extra___default.a.existsSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["join"])(this.srcDir, 'pages'))) {
            if (__WEBPACK_IMPORTED_MODULE_7_fs_extra___default.a.existsSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["join"])(this.srcDir, '..', 'pages'))) {
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          this.routes = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.uniq(__WEBPACK_IMPORTED_MODULE_4_lodash___default.a.map(files, function (file) {
        ...
        case 22:
          ...
          moveTemplates = templatesFiles.map(function (file) {
            return readFile(r(__dirname, 'app', file), 'utf8').then(function (fileContent) {
              var template = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.template(fileContent, {
                imports: {
                  serialize: __WEBPACK_IMPORTED_MODULE_11_serialize_javascript___default.a,
                  hash: __WEBPACK_IMPORTED_MODULE_8_hash_sum___default.a
                }
              });
...
function getWebpackClientConfig() {
  return __WEBPACK_IMPORTED_MODULE_14__webpack_client_config_js__["a" /* default */].call(this);
}

function getWebpackServerConfig() {
  return __WEBPACK_IMPORTED_MODULE_15__webpack_server_config_js__["a" /* default */].call(this);
}
...
function createWebpackMiddleware() {
  ...
  clientConfig.plugins.push(new __WEBPACK_IMPORTED_MODULE_10_webpack___default.a.HotModuleReplacementPlugin(), new __WEBPACK_IMPORTED_MODULE_10_webpack___default.a.NoEmitOnErrorsPlugin());
  var clientCompiler = __WEBPACK_IMPORTED_MODULE_10_webpack___default()(clientConfig);
  // Add the middleware to the instance context
  this.webpackDevMiddleware = __WEBPACK_IMPORTED_MODULE_9_pify___default()(__webpack_require__(44)(clientCompiler, {
  ...
  this.webpackHotMiddleware = __WEBPACK_IMPORTED_MODULE_9_pify___default()(__webpack_require__(45)(clientCompiler));
}
...
function webpackWatchAndUpdate() {
  ...
  var mfs = new MFS();
  var serverConfig = getWebpackServerConfig.call(this);
  var serverCompiler = __WEBPACK_IMPORTED_MODULE_10_webpack___default()(serverConfig);
  var outputPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["join"])(serverConfig.output.path, serverConfig.output.filename);
...
function webpackRunClient() {
  ...
  return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
    ...
    var serverCompiler = __WEBPACK_IMPORTED_MODULE_10_webpack___default()(clientConfig);
...
function createRenderer(bundle) {
  ...
  if (this.options.cache) {
    ...
    cacheConfig = __webpack_require__(38)(__WEBPACK_IMPORTED_MODULE_4_lodash___default.a.defaults(this.options.cache, {
      max: 1000,
      maxAge: 1000 * 60 * 15
    }));
  }
  this.renderer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_vue_server_renderer__["createBundleRenderer"])(bundle, {
    cache: cacheConfig
  });
  this.renderToString = __WEBPACK_IMPORTED_MODULE_9_pify___default()(this.renderer.renderToString);
...
function watchPages() {
  ...
  var refreshFiles = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.debounce(function () {
    var d = Date.now();
    __WEBPACK_IMPORTED_MODULE_5_co___default()(generateRoutesAndFiles.bind(_this5)).then(function () {
      console.log('Time to gen:' + (Date.now() - d) + 'ms'); // eslint-disable-line no-console
    });
  }, 200);
  this.pagesFilesWatcher = __WEBPACK_IMPORTED_MODULE_6_chokidar___default.a.watch(patterns, options).on('add', refreshFiles).on('unlink', refreshFiles);
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_typeof__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_co__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_co___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_co__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_pify__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_pify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_pify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_path_to_regexp__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_path__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_html_minifier__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_html_minifier___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_html_minifier__);
...
var copy = __WEBPACK_IMPORTED_MODULE_6_pify___default()(__WEBPACK_IMPORTED_MODULE_4_fs_extra___default.a.copy);
var remove = __WEBPACK_IMPORTED_MODULE_6_pify___default()(__WEBPACK_IMPORTED_MODULE_4_fs_extra___default.a.remove);
var writeFile = __WEBPACK_IMPORTED_MODULE_6_pify___default()(__WEBPACK_IMPORTED_MODULE_4_fs_extra___default.a.writeFile);
var mkdirp = __WEBPACK_IMPORTED_MODULE_6_pify___default()(__WEBPACK_IMPORTED_MODULE_4_fs_extra___default.a.mkdirp);
...
/* harmony default export */ __webpack_exports__["a"] = function () {
  ...
  ** Set variables
  */
  this.options.generate = __WEBPACK_IMPORTED_MODULE_8_lodash___default.a.defaultsDeep(this.options.generate, defaults);
  var self = this;
  var srcStaticPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["resolve"])(this.srcDir, 'static');
  var srcBuiltPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["resolve"])(this.dir, '.nuxt', 'dist');
  var distPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["resolve"])(this.dir, this.options.generate.dir);
  var distNuxtPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["resolve"])(distPath, '_nuxt');
  return __WEBPACK_IMPORTED_MODULE_5_co___default()(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_regenerator___default.a.mark(function _callee() {
    ...
    */
    ...
    _this.routes.forEach(function (route) {
      if (route.indexOf(':') !== -1 || route.indexOf('*') !== -1) {
        var _ret = function () {
          ...
          route = route + '?';
          var toPath = __WEBPACK_IMPORTED_MODULE_7_path_to_regexp___default.a.compile(route);
    ...
    return __WEBPACK_IMPORTED_MODULE_5_co___default()(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_regenerator___default.a.mark(function _callee3() {
          ...
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return routes.splice(0, 500).map(function (route) {
                return __WEBPACK_IMPORTED_MODULE_5_co___default()(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_regenerator___default.a.mark(function _callee2() {
                  var _ref, html, path;
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 2:
                          ...
                          html = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11_html_minifier__["minify"])(html, {
                          ...
                          path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["join"])(route, __WEBPACK_IMPORTED_MODULE_9_path__["sep"], 'index.html'); // /about -> /about/index.html

                          debug('Generate file: ' + path);
                          path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["join"])(distPath, path);
                          // Make sure the sub folders are created
                          _context2.next = 10;
                          return mkdirp(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["dirname"])(path));
    ...
    var nojekyllPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["resolve"])(distPath, '.nojekyll');
...
function resolveRouteParams(routeParams) {
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(routeParams).forEach(function (routePath) {
    var promise = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10__utils__["promisifyRouteParams"])(routeParams[routePath]);
...
function render(req, res) {
  ...
  var self = this;
  var context = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["getContext"])(req, res);
  return __WEBPACK_IMPORTED_MODULE_2_co___default()(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.mark(function _callee() {
    var url;
...
function renderRoute(url) {
  ...
  var self = this;
  return __WEBPACK_IMPORTED_MODULE_2_co___default()(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.mark(function _callee2() {
    var app, html;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            html = self.appTemplate({
              ...
              context: context,
              files: {
                css: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["urlJoin"])(self.options.router.base, '/_nuxt/', self.options.build.filenames.css),
                vendor: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["urlJoin"])(self.options.router.base, '/_nuxt/', self.options.build.filenames.vendor),
                app: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["urlJoin"])(self.options.router.base, '/_nuxt/', self.options.build.filenames.app)
              }
            });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_extract_text_webpack_plugin__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_progress_bar_webpack_plugin__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_progress_bar_webpack_plugin___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_progress_bar_webpack_plugin__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_webpack_bundle_analyzer__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_webpack_bundle_analyzer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_webpack_bundle_analyzer__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__base_config_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_path__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_path___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_path__);
...
*/
/* harmony default export */ __webpack_exports__["a"] = function () {
  var config = __WEBPACK_IMPORTED_MODULE_8__base_config_js__["a" /* default */].call(this, { isClient: true });

  // Entry
  config.entry.app = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["resolve"])(this.dir, '.nuxt', 'client.js');
  ...
  // Output
  config.output.path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9_path__["resolve"])(this.dir, '.nuxt', 'dist');
  ...
  config.plugins.push(new __WEBPACK_IMPORTED_MODULE_6_progress_bar_webpack_plugin___default.a());

  // Production client build
  if (!this.dev) {
    config.plugins.push(
    // Use ExtractTextPlugin to extract CSS into a single file
    new __WEBPACK_IMPORTED_MODULE_5_extract_text_webpack_plugin___default.a({
  ...
  if (!this.dev && this.options.build.analyze) {
    ...
    config.plugins.push(new __WEBPACK_IMPORTED_MODULE_7_webpack_bundle_analyzer__["BundleAnalyzerPlugin"](options));
  }
  return config;
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_config_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_fs__ = __webpack_require__(32);
...
*/
/* harmony default export */ __webpack_exports__["a"] = function () {
  var config = __WEBPACK_IMPORTED_MODULE_4__base_config_js__["a" /* default */].call(this, { isServer: true });

  // env object defined in nuxt.config.js
  var env = {};
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_lodash__["each"])(this.options.env, function (value, key) {
    env['process.env.' + key] = typeof value === 'string' ? __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify___default()(value) : value;
  });
  ...
  config = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()(config, {
    target: 'node',
    devtool: false,
    entry: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_path__["resolve"])(this.dir, '.nuxt', 'server.js'),
    output: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, config.output, {
      path: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_path__["resolve"])(this.dir, '.nuxt', 'dist'),
      filename: 'server-bundle.js',
      libraryTarget: 'commonjs2'
    }),
    plugins: (config.plugins || []).concat([new __WEBPACK_IMPORTED_MODULE_3_webpack___default.a.DefinePlugin(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()(env, {
      'process.env.NODE_ENV': __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify___default()(this.dev ? 'development' : 'production'),
  ...
  var projectPackageJsonPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_path__["resolve"])(this.dir, 'package.json');
  config.externals = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(nuxtPackageJson.dependencies || {});
  if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_fs__["existsSync"])(projectPackageJsonPath)) {
    try {
      var projectPackageJson = JSON.parse(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_fs__["readFileSync"])(projectPackageJsonPath));
  ...
  config.externals = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_lodash__["uniq"])(config.externals);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_co__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_co___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_co__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_fs_extra__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_pify__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_pify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_pify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ansi_html__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ansi_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_ansi_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_serialize_javascript__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__server__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__build__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__render__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__generate__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_serve_static__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__utils__ = __webpack_require__(4);
...
__WEBPACK_IMPORTED_MODULE_16__utils__["setAnsiColors"](__WEBPACK_IMPORTED_MODULE_8_ansi_html___default.a);
...
var Nuxt = function () {
  function Nuxt() {
    ...
    if (__WEBPACK_IMPORTED_MODULE_6_fs_extra___default.a.existsSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_15_path__["join"])(this.srcDir, 'store'))) {
      this.options.store = true;
    }
    // If middleware defined, update middleware option to true
    this.options.middleware = false;
    if (__WEBPACK_IMPORTED_MODULE_6_fs_extra___default.a.existsSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_15_path__["join"])(this.srcDir, 'middleware'))) {
      this.options.middleware = true;
    }
    // Template
    this.appTemplate = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.template(__WEBPACK_IMPORTED_MODULE_6_fs_extra___default.a.readFileSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_15_path__["resolve"])(__dirname, 'views', 'app.html'), 'utf8'), {
      imports: { serialize: __WEBPACK_IMPORTED_MODULE_9_serialize_javascript___default.a }
    });
    this.errorTemplate = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.template(__WEBPACK_IMPORTED_MODULE_6_fs_extra___default.a.readFileSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_15_path__["resolve"])(__dirname, 'views', 'error.html'), 'utf8'), {
      imports: {
        ansiHTML: __WEBPACK_IMPORTED_MODULE_8_ansi_html___default.a,
        encodeHtml: __WEBPACK_IMPORTED_MODULE_16__utils__["encodeHtml"]
      }
    });
    // renderer used by Vue.js (via createBundleRenderer)
    this.renderer = null;
    // For serving static/ files to /
    this.serveStatic = __WEBPACK_IMPORTED_MODULE_7_pify___default()(__WEBPACK_IMPORTED_MODULE_14_serve_static___default()(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_15_path__["resolve"])(this.srcDir, 'static')));
    // For serving .nuxt/dist/ files
    this._nuxtRegexp = /^\/_nuxt\//;
    this.serveStaticNuxt = __WEBPACK_IMPORTED_MODULE_7_pify___default()(__WEBPACK_IMPORTED_MODULE_14_serve_static___default()(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_15_path__["resolve"])(this.dir, '.nuxt', 'dist')));
    // Add this.Server Class
    this.Server = __WEBPACK_IMPORTED_MODULE_10__server__["a" /* default */];
    // Add this.build
    __WEBPACK_IMPORTED_MODULE_11__build__["a" /* options */].call(this); // Add build options
    this.build = function () {
      return __WEBPACK_IMPORTED_MODULE_5_co___default()(__WEBPACK_IMPORTED_MODULE_11__build__["b" /* build */].bind(_this));
    };
